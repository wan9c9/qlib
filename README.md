...
**Note**: 
1. **Conda** is suggested for managing your Python environment. There could be dependency conflict with your current environments. If this is the case, it's best to create a new environment for qlib.
